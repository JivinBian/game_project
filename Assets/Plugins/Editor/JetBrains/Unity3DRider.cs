...
namespace Plugins.Editor.JetBrains
{
  ...
  {   
    ...
    /// </summary>
    /// <param name="projectDirectory">ModelName to the project root directory</param>
...
#else
            EditorSettings.externalVersionControl.Contains(ModelName.GetExtension(assetFilePath).Substring(1))
#endif 
            ))) 
          return false;
